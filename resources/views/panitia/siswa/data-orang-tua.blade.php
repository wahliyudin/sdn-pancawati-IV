<div class="box box-info padding-1">
    <div class="box-body">
        ...
        <input disabled type="hidden" name="user_id" value="{{ $identitas->user_id }}">
        <h3>Data Ayah</h3>
        <hr>
        <div class="row">
            <div class="col-12 col-sm-6">
                <div class="form-group">
                    ...
                    <input disabled type="text" name="nama_ayah"
                ...
                <div class="form-group">
                    ...
                    <input disabled type="email"
                        class="form-control {{ $errors->has('email_ayah') ? ' is-invalid' : '' }}" id="email_ayah"
                        name="email_ayah" value="{{ old('email_ayah', $orang_tua->father->email) }}"
                        placeholder="E-Mail ayah">
                    @error('email_ayah')
                        <p class="invalid-feedback">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div class="col-12 col-sm-6">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group date" id="tanggal_lahir_ayah" data-target-input="nearest">
                        <input disabled type="text" name="tanggal_lahir_ayah"
                ...
                <div class="form-group">
                    ...
                    <input disabled type="number"
                        class="form-control {{ $errors->has('no_hp_ayah') ? ' is-invalid' : '' }}" id="no_hp_ayah"
                        name="no_hp_ayah" value="{{ old('no_hp_ayah', $orang_tua->father->no_hp) }}"
                        placeholder="No.Telp ayah">
                    @error('no_hp_ayah')
                        <p class="invalid-feedback">{{ $message }}</p>
                    @enderror
                </div>
        ...
        <div class="row">
            <div class="col-12 col-sm-6">
                <div class="form-group">
                    ...
                    <input disabled type="text"
                        class="form-control {{ $errors->has('nama_ibu') ? ' is-invalid' : '' }}" id="nama_ibu"
                        name="nama_ibu" value="{{ old('nama_ibu', $orang_tua->mother->nama) }}"
                ...
                <div class="form-group">
                    ...
                    <input disabled type="email"
                        class="form-control {{ $errors->has('email_ibu') ? ' is-invalid' : '' }}" id="email_ibu"
                        name="email_ibu" value="{{ old('email_ibu', $orang_tua->mother->email) }}"
            ...
            <div class="col-12 col-sm-6">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group date" id="tanggal_lahir_ibu" data-target-input="nearest">
                        <input disabled type="text" name="tanggal_lahir_ibu"
                        ...
                        <div class="input-group-append" data-target="#tanggal_lahir_ibu" data-toggle="datetimepicker">
                            <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                        </div>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <input disabled type="number"
                        class="form-control {{ $errors->has('no_hp_ibu') ? ' is-invalid' : '' }}" id="no_hp_ibu"
                        name="no_hp_ibu" value="{{ old('no_hp_ibu', $orang_tua->mother->no_hp) }}"
                        placeholder="No.Telp ibu">
                    @error('no_hp_ibu')
                        <p class="invalid-feedback">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div class="col-12">
                <div class="form-group">
                    ...
                    <textarea disabled name="alamat" id="" cols="30"
                        class="form-control {{ $errors->has('alamat') ? ' is-invalid' : '' }}"
                        placeholder="Alamat">{{ old('alamat', $orang_tua->alamat) }}</textarea>
                    @error('alamat')
                        <p class="invalid-feedback">{{ $message }}</p>
                    @enderror
                </div>
